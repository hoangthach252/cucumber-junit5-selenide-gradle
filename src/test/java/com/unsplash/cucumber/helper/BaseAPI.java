package com.unsplash.cucumber.helper;
...
public class BaseAPI {
    ...
    public static Response sendPostRequest(String url, Map<String, String> listHeader, RequestBody requestBody, boolean auth) {
        OkHttpClient httpClient = new OkHttpClient();
        Request.Builder requestBuilder = new Request.Builder();
        listHeader.forEach(requestBuilder::addHeader);
        if (auth) {
    ...
    public static Response sendDeleteRequest(String url, Map<String, String> listHeader, RequestBody requestBody, boolean auth) {
        OkHttpClient httpClient = new OkHttpClient();
        Request.Builder requestBuilder = new Request.Builder();
        listHeader.forEach(requestBuilder::addHeader);
        if (auth) {
